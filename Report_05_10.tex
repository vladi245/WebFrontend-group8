...
% Title and Author
\title{\textbf{GetStanding: A Web Application for Healthier Desk Habits}\\ 
Web Technologies, (E25) - Frontend Assignment \\(SE3S-WET Internal Course Code/T630009401 Course ID) \\University of Southern Denmark, The Faculty of Engineering,
Sønderborg Campus}
\author{\textbf{Group 8:} \\ Piotr Szczesny –piszc24@student.sdu.dk \\ Vlad-Alexandru Ionita -vlion24@student.sdu.dk \\ Karolina Malik -kamal24@student.sdu.dk \\ Bartosz Bobkiewicz -babob24@student.sdu.dk \\ Viktor Barabás -vibar24@student.sdu.dk \\ Azra Talum -aztal24@student.sdu.dk}
...
\\\\
\textbf{Contributions:} Readers will learn how to create a simple React Vite + TypeScript web application. The project demonstrates a component-based structure and a functional navigation system using routing. Although this early-stage version relies primarily on basic \texttt{<h1>} and \texttt{<nav>} elements, it provides practical experience in developing a frontend app from initial design to a minimum viable stage. The project also emphasizes clarity and organization, such as separating styles into .module.css files for maintainable CSS management.
...
\begin{itemize}[noitemsep]
    ...
    \item Error 404 page used to redirect lost users.
\end{itemize}
...
\begin{itemize}[noitemsep]
    ...
    \item \textbf{Back To Homepage:} Clicking on a GetStanding Logo redirects users to the homepage.
\end{itemize}
