...
% the formula
When trying to establish the reccmoneded height of the desk for the user, the team research various approaches. Most of the sources did not include a direct formula. As for GetStanding a formula was neccessary, the decision was made to choose formulas from websites and not research papers. The team found a formula made by Kushagra Agarwal \cite{recheightstand} for the standing desk height and followed the formula from a article posted by Weberburo \cite{recheightsit} for the sitting desk height. The multiplication by 10 is done to convert the height from cm to mm.\\
