...
The flowchart visually represents the process of user loging in and  the subsequent flow within the GetStanding Dashboard. The user's journey begins at the home page. If the user is new to the application then they are first required to register an account before procceding to log in, while eisting users navigate directly to log in process. Upon succesful authentication the system directs the user to the appropriate dashboard either Premium or Standard based on their assigned account type. 
