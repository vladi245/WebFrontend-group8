...
This project serves as a preventive health solution, aiming to encourage the users to adopt healthier habits during their workday. GetStanding aims to track and monitor the duration of sitting and provide users insight into their standing habits over time. By visualizing weekly performance and tracking progress, GetStanding helps users stay motivated and consistent.

\subsection{Key Challenges} 
One of the the primary challenges with this project is to encourage users to keep track of their daily time spent standing, and adopt lasting behavioral changes. The process of habit formation requires sustained time and effort, many users may ignore the daily stats if they are too busy or if they lack the motivation. This may decrease the effectiveness of the proposed solution. \\\\
