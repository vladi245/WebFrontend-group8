...
% the formula
According to Don B. Chaffin and Gunnar B.J Andersson\cite{recheight2} in their work Occupational Biomechanics, to determine the correct desk height you need to look into the biomechanical relationship betwen the user's stature and their seated elbow height. To achieve an ergonomically neutral posture that minimises muscle stress the following formulas and principles should be applied:\\\\
\textbf{Sitting Height:}\\ 
H = (0.198 * height) + 39.27\\\\
Where:
\begin{itemize}
	\item 0.198 - The multiplier represents the antrhopometric ratio of how seated elbow height scales with total body height.
	\item 39.27 - The constant that accounts for the baseline variables including avarage chair seat height, pelvic thickness and the necessarry clearence for the thigs.
\end{itemize}
\textbf{Standing Height:}\\
H = (0.628*height)\\\\
Where:
\begin{itemize}
\item 0.628 - This is the anthropometric constant for standing elbow height. The avarage persons elbow is located at approximately 62.8\% of their total height.\\\\
\end{itemize}
The team decided to follow their approach when giving the recommendation to the user.  In order to avoid floting point numbers the team decided to round the value recieved from the formula.
