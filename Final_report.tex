...
\subsection{Delimitation - LOOK AT THIS}
Most of our problems the team encountered were related to the time limitation. Previously planned features, such as a friends page and rewards, ended up not being implemented due to limited the time capacity to implement them.  As for the application itself, a limiting factor can be if the user is not constantly keeping track of their workouts, water and food consumption. In this case, the charts will not be able to present the improvement in their habits.
...
\subsubsection{Data Storage and Infrastructure - LOOK AT THIS}
...
The study of Gao, W., et al. (2024). Occupational Sitting Time, Leisure Physical Activity, and All-Cause and Cardiovascular Disease Mortality reports that people who predominantly sit at work have a 16\%  higher risk of mortality from all causes, and a 34\% higher risk of mortality from cardiovascular disease. To counteract the increased risk, sedentary individuals would have to engage in an additional 15 to 30 minutes of physical activity per day. \\\\
...
\subsection{Prototyping  - LOOK AT THIS}
...
\end{figure}
\subsection{Diagrams}
\subsubsection{Sequence Diagram - LOOK AT THIS}
...
\end{figure}
\subsubsection{Flowchart Diagram - LOOK AT THIS}
...
\subsection{Future Work  - LOOK AT THIS}
