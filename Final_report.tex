...
\begin{figure}[H] 
    \centering 
    \includegraphics[width=0.3\textwidth]{allsprints.png}\\
...
\begin{figure}[H] 
    \centering 
    \includegraphics[width=0.4\textwidth]{sprint4.png}\\
    \caption{Sprint 4 planning document outlining sprint goals, team roles, and backlog items. }
\end{figure}

\begin{figure} [H]
	\centering
	\includegraphics[width=0.5\textwidth]{sprint3.png}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.5\textwidth]{jira.png}
