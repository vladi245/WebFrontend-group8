...
\subsection{Backend}
The backend follows the MVC framework to ensure a well-structured project. The backend techstack uses Express.js and a PostgreSQL database running in with Docker.
