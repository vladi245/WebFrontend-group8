...
\subsection{Backend}
The backend follows the MVC framework principles to assure a well structured project. The techstack includes using Express.js and handling the database using PostegreSQL, finally using Docker for managing containers. 
...
\\
Description: WorkoutRecord allows the user to interact and handle his workout data.
\\
\begin{itemize}
...
\item deleteByID (DELETE) - User removes his workout from his records.
