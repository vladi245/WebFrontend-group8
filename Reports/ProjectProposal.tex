...
\hline
Integration issues may occur between web technologies project and semester project. & 
Testing integration regularly and coordinating development progress. \\
\hline
Weak authentication or poor data handling may expose sensitive information. &
Authentication using basic hashing. Passwords are securely hashed before being stored, while user details are kept in plain form. \\
\hline
\end{tabular}
\end{table}

\subsection*{Project Management and Organisational Risks}
\begin{table}[h]
\centering
\renewcommand{\arraystretch}{1.3}
\begin{tabular}{|p{0.25\linewidth}|p{0.65\linewidth}|}
...
\textbf{Risks} & \textbf{Solutions} \\
\hline
Poor team coordination or communication may lead to delays or slow down the progress. & 
Hold regular Scrum meetings, provide progress updates and keep project documentation organized. \\
\hline
Some members may lack experience with microservices and hardware. & 
Divide tasks based on team members' strengths and encourage pair programming. \\
\hline
\end{tabular}
\end{table}
