...
\begin{itemize}
    ...
    \item Connect the Fitness WebApp to the desk through the API
...
\begin{itemize}
    ...
    \item \textbf{APIs:} Provides communication between the Desk Management REST API and the back-end logic.
\end{itemize}
...
\begin{itemize}
    ...
    \item The UI shall be allowing input of user data.
...
\section{Methods}
\begin{itemize}
    \item \textbf{Development Methodology:} Agile/Scrum with 2-week sprints, sprint reviews, and retrospectives
...
\section{Risks}
\begin{itemize}
    \item \textbf{Team Coordination Issues:} Minimized through regular Scrum meetings and documentation.
    \item \textbf{Technical Complexity:} Divide tasks based on team members' strengths
    \item \textbf{Integration Issues:} Keep in mind the semester project during the web technologies project's development.
\end{itemize}
